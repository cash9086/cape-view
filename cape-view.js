...
var LAG    = 0.06;     /* quanto insegue: 1 = incollata al mouse. Meno
                          intuitivo di quel che sembra, il ritardo che si
                          vede va come (1-LAG)/LAG — a 0.06 la scritta resta
                          indietro di un centinaio di pixel e ci mette mezzo
                          secondo buono ad arrivare. E' l'inerzia grossa     */
var CAP    = 400;      /* e comunque non si stacca mai piu' di tanti px: e'
                          il guinzaglio, non il freno. Su una sventagliata
                          da una parte all'altra dello schermo evita che
                          finisca fuori dall'immagine                        */
